...
export const MinimizeIcon: React.FC<{size?: number}> = ({size = 20}) => (
    <svg
        width={size}
        height={size}
        viewBox='0 0 24 24'
    ...
    >
        {/* Lucide minimize-2 path: arrows pointing inward at corners */}
...
export const ExpandIcon: React.FC<{size?: number}> = ({size = 20}) => (
    <svg
        width={size}
        height={size}
        viewBox='0 0 24 24'
        ...
        strokeLinejoin='round'
    >
        {/* Lucide maximize-2 path: arrows pointing outward at corners */}
...
export const HandIcon: React.FC<{size?: number}> = ({size = 20}) => (
    <svg
        width={size}
        height={size}
        viewBox='0 0 24 24'
